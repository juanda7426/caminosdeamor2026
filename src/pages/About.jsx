              ...
              <div className="col-lg-6">
                <div className="content-card bg-corporate">
                  ...
                  <p className="text-content">
                    Nuestra funeraria se especializa en el cuidado y cremación
                    de mascotas. Estamos orgullosos de ser parte de este proceso
                    tan importante y emotivo para ti y tu compañero peludo.
                    Nuestro compromiso es brindar un servicio de alta calidad y
                    respeto a las necesidades de nuestros amigos de cuatro patas
                    que han partido.
                  </p>
                  <p className="text-content mt-2">
                    ...
                    tiene en cuenta para garantizar que el cremación de tu
                    mascota sea un recuerdo digno.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-6">
                <div className="content-card bg-vision">
                  ...
                  <p className="text-content mt-2">
                    ...
                    honrando la memoria de esos seres queridos que forman parte
                    de nuestras familias. Trabajamos con pasión y dedicación
                    para aliviar el dolor de quienes atraviesan este difícil
                    momento.
                  </p>
                </div>
              </div>
