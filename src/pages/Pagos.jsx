		...
		<>
			...
			<div className='modern-section container'>
				...
				<div className='payment-info-box'>
					...
					No olvides enviar el comprobante de pago para registrar la mensualidad de tu mascota.
				</div>
				...
				<div className='row g-4 justify-content-center'>
					...
					<div className='col-lg-4 col-md-6'>
						<div className='payment-card'>
							...
							<p className='text-muted mb-4'>Puedes acercarte a nuestra sede principal para realizar tus pagos en efectivo.</p>
					...
					<div className='col-lg-4 col-md-6'>
						<div className='payment-card'>
							...
							<img src='../../img/nequi.jpeg' alt='QR Nequi' className='payment-img' />
						</div>
					</div>
					...
					<div className='col-lg-4 col-md-6'>
						<div className='payment-card'>
							...
							<img src='../../img/bancolombia.jpeg' alt='QR Bancolombia' className='payment-img' />
						</div>
					</div>
				</div>
			</div>
