		...
		<div>
			...
			<div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
				...
				<div style={cardStyle}>
					...
					<p style={{ fontSize: "2rem", margin: "10px 0" }}>{loading ? "..." : stats.infoConfigured ? "✅" : "❌"}</p>
					<p style={{ color: "#666" }}>{stats.infoConfigured ? "Configurada" : "Sin configurar"}</p>
					<Link to='/admin/info' style={{ color: "#d1b06b", textDecoration: "none", fontWeight: "bold" }}>
						Editar Info &rarr;
					</Link>
				</div>
				...
				<div style={cardStyle}>
					<h3>Convenios</h3>
					<p style={{ fontSize: "2rem", margin: "10px 0" }}>{loading ? "..." : stats.partnersCount}</p>
					<p style={{ color: "#666" }}>Activos</p>
					<Link to='/admin/convenios' style={{ color: "#d1b06b", textDecoration: "none", fontWeight: "bold" }}>
				...
				<div style={cardStyle}>
					...
					<p style={{ fontSize: "2rem", margin: "10px 0" }}>{loading ? "..." : stats.plansCount}</p>
					<p style={{ color: "#666" }}>Disponibles</p>
					<Link to='/admin/planes' style={{ color: "#d1b06b", textDecoration: "none", fontWeight: "bold" }}>
				...
				<div style={cardStyle}>
					<h3>Promociones</h3>
					<p style={{ fontSize: "2rem", margin: "10px 0" }}>{loading ? "..." : stats.promosCount}</p>
					<p style={{ color: "#666" }}>Activas</p>
					<Link to='/admin/promos' style={{ color: "#d1b06b", textDecoration: "none", fontWeight: "bold" }}>
